...
const AdminDashboard = () => {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.grid}>
        {['Assigned Schools','Pending','Completed','Rejected'].map((label, i) => (
...
const s = {
  ...
  header:{ background:'#2d5986', color:'#fff', padding:'1.5rem 2rem', display:'flex', justifyContent:'space-between', alignItems:'center' },
  ...
  cardValue:{ margin:0, fontSize:'2rem', fontWeight:'700', color:'#2d5986' },

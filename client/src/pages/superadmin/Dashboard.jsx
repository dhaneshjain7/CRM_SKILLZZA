...
const SuperAdminDashboard = () => {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.grid}>
        {['Total Schools','Total Admins','Active','Pending'].map((label, i) => (
...
const s = {
  ...
  header:{ background:'#1e3a5f', color:'#fff', padding:'1.5rem 2rem', display:'flex', justifyContent:'space-between', alignItems:'center' },
  ...
  cardValue:{ margin:0, fontSize:'2rem', fontWeight:'700', color:'#1e3a5f' },
